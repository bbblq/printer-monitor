...
- **消息通知**：
  - **耗材耗尽提醒**：当墨粉用尽时立即发送通知
  - **耗材更换提醒**：当检测到耗材被更换时发送通知
  - **耗材不足提醒**：当耗材低于设定阈值时发送提醒
  - **定期报表**：支持配置 Cron 定时发送耗材状态报表
  - **多渠道支持**：企业微信、飞书、邮件三种通知方式
- **后台管理**：
...
#### 🔔 消息通知功能
- 新增 **消息通知模块**，支持耗材耗尽、更换、低量三种提醒
- 支持 **企业微信** Webhook 机器人推送
- 支持 **飞书** Webhook 机器人推送
- 支持 **邮件** 推送（SMTP 配置）
- 支持 **定期报表** 功能（Cron 表达式配置）
- 后台新增通知设置管理界面
